---
  title: 'Small Guide'
  image: '/images/small-guide/thumbnail.webp'
...
<GridCols>
  <CldImage width="400" height="800" src="https://res.cloudinary.com/dtce87smh/image/upload/v1676228381/small-guide/home_k8aybg.webp" className="rounded-lg" />
  <CldImage width="400" height="800" src="https://res.cloudinary.com/dtce87smh/image/upload/v1676228381/small-guide/process-map_kyi8jg.webp" className="rounded-lg" />
  <CldImage width="400" height="800" src="https://res.cloudinary.com/dtce87smh/image/upload/v1676228382/small-guide/trip_iuk3bi.webp" className="rounded-lg" />
</GridCols>

<GridCols>
  <CustomImage src="/images/small-guide/home.jpg" height={800} width={400} />
  <CustomImage
    src="/images/small-guide/process-map.png"
    height={800}
    width={400}
  />
  <CustomImage src="/images/small-guide/trip.png" height={800} width={400} />
</GridCols>

<GridCols>
  <CustomImage src="/optimized/small-guide/home.webp" height={800} width={400} />
  <CustomImage
    src="/optimized/small-guide/process-map.webp"
    height={800}
    width={400}
  />
  <CustomImage src="/optimized/small-guide/trip.webp" height={800} width={400} />
</GridCols>
...
<CustomImage src="/images/small-guide/mockup.png" height={2160} width={1080} />
...
There are a lot more things that would be nice to mention, like designing architecture of application, keeping code clean and well structured but in my case it's continous improvement, and it also changes
with technology changes, like nowadays there has been a lot of changes to _Next.js 13_ that turns upside down whole navigation and rendering app.
