...
export const Navbar = () => {
  ...
  return (
    <motion.nav
      ...
      style={{ left: x }}
      className="navbar fixed bottom-0 z-30 items-start overflow-hidden overflow-y-auto border-t-2 border-blockBg bg-background text-white sm:border-none md:top-0 md:mr-4 md:w-32 md:bg-transparent"
    >
      <div className="flex w-screen justify-between py-2 md:h-screen md:w-auto md:flex-col md:py-12 md:pl-12 lg:py-16 lg:pl-20">
        <motion.div
          key="nav-toggle"
          initial="collapsed"
          animate="open"
          variants={{
            open: { opacity: 1, scale: 1, transition: { delay: 0.5 } },
            collapsed: { opacity: 0, scale: 0.4 },
          }}
          className="nav-toggle hidden md:block"
        >
