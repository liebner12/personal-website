...
import { NavbarLink, SkipToContent } from 'components';
  ...
  return (
    <SkipToContent id="Skip navbar">
      <motion.nav
        {...FADE_IN_X_REVERSE}
        style={{ left: x }}
        className="navbar fixed bottom-0 z-30 w-full items-start border-t-2 border-grey-800 bg-background text-white transition-all sm:border-none md:top-0 md:mr-4 md:w-32 md:bg-transparent"
      >
